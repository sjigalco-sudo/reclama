Понял, убираем лишние символы. Если мы пробуем формат AIR, то в нем кавычки действительно могут мешать парсеру, если он настроен на максимально простой текст. Также я изменил логику именования файлов: теперь они будут называться строго по времени выхода (например, 10-00-00.air), без названия исходного Excel-файла.

Ниже код, который генерирует AIR и TXT файлы без кавычек в путях.
