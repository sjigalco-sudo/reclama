Вот полный, исправленный и структурированный код со всеми твоими пожеланиями: переименованным разделом MD+SP, центрированным логотипом, группировкой блоков для TopShop и красивым названием архива.
    ...
    try:
        ...
        with zipfile.ZipFile(zip_buffer, "a", zipfile.ZIP_DEFLATED, False) as zip_file:
            if mode_topshop:
                ...
                for index, row in df_raw.iterrows():
                    ...
                    if pd.notna(row[1]) and (":" in str(row[1])) and pd.notna(row[3]):
                        ...
                        if current_block_items and t_obj:
                            ...
                            # Если разрыв > 6 минут — создаем новый файл
                ...
                # Сохранение последнего накопленного блока
